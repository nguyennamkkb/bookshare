...
<a href="{{ url("admin/evaluate/create")}}"><button type="button" class="btn btn-default btn-sm">
...
<div class="form-search search-only">                        
  {!! Form::open(['method'=>'get','url'=>'admin/evaluate']) !!}
...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$key->name}} </td>
      <td>
        <a href="{!! url('admin/evaluate/'.$key->id.'/edit')!!}"> 
      ...
      <td>
        {!! Form::open(['method'=>'delete','url'=>['admin/evaluate',$key->id]]) !!}
